 ...
 * @author Jimmy
 */
public class HibridBotParams extends UT2004BotParameters {
	 ...
	 * @return
	 */
	public HibridBotParams setBotSkin(String botSkin) {
	 ...
	 * @return
	 */
	public HibridBotParams setSkillLevel(int skillLevel) {
	 ...
	 * @return
	 */
	public HibridBotParams setTeam(int team) 
	{
		super.setTeam(team);
		return this;
	}
