 ...
 * @author Michal Bida
 */
public class CustomControlServerModule extends UT2004ServerModule {
	...
	protected void configureModules() {
		...
		addModule(new AbstractModule() {
			...
			public void configure() {
				...
				bind(IUT2004Server.class).to(CustomControlServer.class); //Here we tell guice it should create our custom Control server class
			}
